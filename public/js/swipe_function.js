...
function refresh_hide(){
  ...
  $('#d_left').children('.img_photo').css('visibility', 'hidden');
  $('#d_up').children('.img_photo').css('visibility', 'hidden');
  $('#d_down').children('.img_photo').css('visibility', 'hidden');
  $('#d_right').children('.img_photo').css('visibility', 'hidden');
  myApp.charging();
}
